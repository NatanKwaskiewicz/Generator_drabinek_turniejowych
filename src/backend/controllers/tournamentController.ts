...
export const getOneTournament = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const postTournament = async (req: Request, res: Response, next: NextFunction) => {
    try {
